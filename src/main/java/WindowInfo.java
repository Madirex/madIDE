...
public class WindowInfo extends JFrame {
    ...
    private void initialize(){
        ...
        //Agregar Icono debug
            ...
            title.setBorder(BorderFactory.createEmptyBorder(0, 0, 5, 0)); //Crear márgenes
            ...
            description.setBorder(BorderFactory.createEmptyBorder(0, 0, 5, 0)); //Crear márgenes
            ...
            copyright.setBorder(BorderFactory.createEmptyBorder(0, 0, 5, 0)); //Crear márgenes
            ...
            web.setBorder(BorderFactory.createEmptyBorder(0, 0, 5, 0)); //Crear márgenes
